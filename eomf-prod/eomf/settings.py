...
#LANGUAGE_CODE = 'es-ES'
LANGUAGES = ( 
    ('en',string_concat('English (',_('English'),')')),
    ('zh-cn',string_concat('中国简化 (',_('Chinese'),')')),
    ('es',string_concat('Español (',_('Spanish'),')')),
    ('ne',string_concat('नेपाली (',_('Nepali'),')')),
    ('fr',string_concat('Français(',_('French'),')')),
)
...
SECRET_KEY = 'p%ze4z_*#-8i5%_8lxcg=0foeg+ct=b_yclfn1k11s_4)c=o@&'
